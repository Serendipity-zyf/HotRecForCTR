...
class DCNv2Config(BaseModelConfig):
    """Configuration for DCNv2 model."""

    Name: Literal["DCNv2"] = "DCNv2"
    ...
    num_dnn_layers: PositiveInt = 3
    num_cross_layers: PositiveInt = 4
    interact_feature_nums: Optional[PositiveInt] = None
    is_interact: bool = False


DCNv2OptimizerConfig = OptimizerConfig(
    type="Adam",
...
DCNv2SchedulerConfig = SchedulerConfig(
    type="StepLR",
    step_size=10,
    gamma=0.9,
)
...
class DCNv2TrainerConfig(BaseTrainerConfig):
    """Configuration for DCNv2 trainer."""
    ...
    optimizer: OptimizerConfig = DCNv2OptimizerConfig
    scheduler: SchedulerConfig = DCNv2SchedulerConfig

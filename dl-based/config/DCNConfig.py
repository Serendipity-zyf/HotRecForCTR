...
class DCNConfig(BaseModelConfig):
    """Configuration for DCN model."""

    Name: Literal["DCN"] = "DCN"
...
DCNSchedulerConfig = SchedulerConfig(
    type="StepLR",
    step_size=10,
    gamma=0.9,
)
...
class DCNTrainerConfig(BaseTrainerConfig):
    """Configuration for DCN trainer."""
    ...
    optimizer: OptimizerConfig = DCNOptimizerConfig
    scheduler: SchedulerConfig = DCNSchedulerConfig

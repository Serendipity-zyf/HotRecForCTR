...
def args_parser():
    ...
    group.add_argument(
        "--wandb_entity", type=str, help="Wandb entity (required if --is_wandb is used)"
    )
    group.add_argument("--wandb_project", type=str, default="RecForCTR", help="Wandb project name")
